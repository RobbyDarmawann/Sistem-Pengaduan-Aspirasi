            ...
            <div class="bg-[#347ab7] p-8 md:p-12 text-white rounded-l-2xl">
                ...
                <form action="#" method="POST">
                    <div class="mb-5">
                        ...
                        <input type="text" id="login-email" name="email" class="w-full px-4 py-3 rounded-lg bg-gray-100 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Masukkan data Anda" required>
                    </div>
                    <div class="mb-8">
                        <label for="login-password" class="block mb-2 text-sm font-medium">Password</label>
                        <input type="password" id="login-password" name="password" class="w-full px-4 py-3 rounded-lg bg-gray-100 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Masukkan password Anda" required>
                    </div>
                    <button type="submit" class="w-full py-3 px-6 rounded-lg font-semibold bg-gray-200 text-gray-800 hover:bg-gray-300 transition-colors duration-300">
                        Masuk
                    </button>
                </form>
    ...
    <div id="register-modal" class="relative w-full max-w-3xl bg-[#347ab7] text-white rounded-2xl shadow-xl hidden max-h-[90vh] flex flex-col">
        ...
        <div class="p-8 md:p-12 overflow-y-auto">
            ...
            <form id="register-form">
                @csrf <div id="general-error" class="text-red-300 text-sm mb-4 hidden"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <label for="register-password" class="block mb-2 text-sm font-medium">Password</Daftarlabel>
                            <input type="password" id="register-password" name="password" class="w-full px-4 py-3 rounded-lg bg-gray-100 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Buat password Anda" required>
